...
* **Wniosek:** Docker gwarantuje identyczne środowisko na każdej maszynie, eliminując konflikty wersji i błędy typu "u mnie działa".
...
* **Wniosek:** Analiza statyczna APK pozwala wykryć podatności (zahardkodowane klucze, niebezpieczne uprawnienia, debuggable=true) zanim aplikacja w ogóle zostanie uruchomiona.

### 🔹 BLOK 3-4: Fundamenty Skryptowania (Python for QA)
Budowa logiki testowej w języku Python.
* **Co zrobiono:** Praca z listami, słownikami, funkcjami i obsługą wyjątków jako fundamentami logiki testowej w Pythonie - w tym inspektory elementów UI i lokalizatory XPath/ID.
